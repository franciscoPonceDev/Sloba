...
import DarkPageBreak from './DarkPageBreak';
import ReverseDarkPageBreak from './ReverseDarkPageBreak';

const Hero = () => (
  <div>
    <main className="h-35vh my-24 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
